...
In [part 1](/post/blogdown-website-1/), I covered how to create a website using [blogdown](https://bookdown.org/yihui/blogdown/), [Hugo](https://gohugo.io/), and [Netlify](https://www.netlify.com/).

In this part, we'll move the website to [GitHub](https://GitHub.com), which provides a nice and more automated workflow for editing and deploying your site.
