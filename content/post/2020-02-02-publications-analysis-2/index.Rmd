...
**New:** In the current version of `bibliometrix`, reading in my bibtex file failed. A good new alternative is to go to your NIH "My Bibliography" (which anyone with NIH funding needs to have anyway) and export it in MEDLINE format. Then read in the file with the code below.
