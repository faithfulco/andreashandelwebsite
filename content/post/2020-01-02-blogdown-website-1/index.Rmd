...
* You are (or would like to be) an R, RMarkdown and GitHub user. This is a method of creating a website ses those tools and very efficiently fits into such a workflow. 
...
You can stick with this process of deploying your website manually. If you want something more automated, check out [part 2 of this tutorial](./blogdown-website-2/), where you'll learn how to use Github to make deployment to Netflify fully automatic.
