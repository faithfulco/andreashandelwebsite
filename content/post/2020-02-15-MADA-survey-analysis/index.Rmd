...
library('knitr')
library('kableExtra')
library('emo') #not on CRAN, install from github
```
...
**First conclusion: Reduce weekly workload, probably best by reducing assigned reading (see text answers which I already glimpsed at `r emo::ji('smiley')`).**
...
About twice as many positive as negative words, i guess that's good `r emo::ji('smiley')`. And the most frequent negative words do reflect that things are "too much". 
